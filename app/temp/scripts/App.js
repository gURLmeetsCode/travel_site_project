...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            (0, _jquery2.default)(document).keyup(this.kepPressHandler.bind(this));
        }
    }, {
        key: "kepPressHandler",
        value: function kepPressHandler(e) {
            if (e.keyCode == 27) {
                this.closeModal();
            }
        }
...
var StickyHeader = function () {
  ...
  // Handles integration conflicts between waypoints and lazysizes.
...
var mobileMenu = new _MobileMenu2.default(); // dont forget to require your files from modules.

new _RevealOnScroll2.default((0, _jquery2.default)(".feature-item"), "85%"); // for feature items
new _RevealOnScroll2.default((0, _jquery2.default)(".testimonials"), "60%"); // for testimonials section
